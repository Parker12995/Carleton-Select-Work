...
# proj4string(sim_points_coor) <- proj4string(minneapolis_tracts)
...
```{r}
proj4string(as_Spatial(all_tracts_loop))
```
...
write.csv(
  ...
  paste("./lgcp_likelihood_inputs/observed_pts.csv", sep=""),
  row.names = FALSE)
```
...
write.csv(
  ...
  paste("./lgcp_likelihood_inputs/observed_pts_var.csv", sep=""),
  row.names = FALSE)
```
...
write.csv(
  ...
  paste("./lgcp_likelihood_inputs/", as.character(multiplier), ".csv", sep=""),
  row.names = FALSE
)
```
...
write.csv(
  ...
  paste("./lgcp_likelihood_inputs/", as.character(multiplier), "_var", ".csv", sep=""),
  row.names = FALSE)
```
...
write.csv(
  ...
  "./lgcp_likelihood_inputs/knots.csv", 
  row.names=FALSE
)
```
